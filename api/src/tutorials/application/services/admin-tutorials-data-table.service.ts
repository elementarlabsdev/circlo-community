...
// Admin DataTable config for tutorials
...
@Injectable()
export class AdminTutorialsDataTableService extends DataTableService<any> {
  constructor(prisma: PrismaService) {
    super(prisma, config);
  }

  // Enforce only published tutorials in admin table
