...
import { AdminTopicListService } from './admin-topic-list.service';
import { TableColumn } from '@/common/domain/interfaces/interfaces';

@Injectable()
export class AdminTopicsTableService {
  private _defs = {
    id: {
      column: {
        name: 'Id',
  ...
  constructor(private _topicListService: AdminTopicListService) {}
  ...
  async getPayload(
    ...
    return {
      ...
      ...(await this._topicListService.findPaginated(
        pageSize,
        pageNumber,
        search,
