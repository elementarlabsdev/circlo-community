...
@Injectable()
export class StudioPublicationsTableService {
  private readonly _defs: { [key: string]: any } = {};

  constructor(private _publicationListService: StudioPublicationListService) {
    this._defs = {
      id: {
        column: {
          name: 'Id',
