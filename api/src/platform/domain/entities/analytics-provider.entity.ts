...
export class AnalyticsProvider {
  ...
  private constructor(props: AnalyticsProviderProps) {
    this.id = props.id;
  ...
  static reconstitute(props: AnalyticsProviderProps): AnalyticsProvider {
    return new AnalyticsProvider(props);
  }

  update(data: { isEnabled?: boolean; config?: any | null; isConfigured?: boolean }) {
